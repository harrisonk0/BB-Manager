...
const InviteCodeManagementPreview: React.FC = () => {
    const activeSection = localStorage.getItem('activeSection') as Section | null;
    const isCompany = activeSection === 'company';
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md border border-slate-200">
            ...
            <h3 className="text-lg font-semibold text-slate-700 mt-6 mb-3">Existing Invite Codes</h3>
            <ul className="divide-y divide-slate-200 border border-slate-200 rounded-md">
                <li className="p-3 flex items-center justify-between text-sm">
                    <div className="flex-1">
                        <span className="font-mono text-slate-800">CODE123</span>
                        <p className="text-xs text-slate-500 mt-1">Generated by admin@example.com on 01/01/2023</p>
                    </div>
                    <span className="px-2 py-0.5 text-xs font-medium bg-green-100 text-green-800 rounded-full">Active</span>
                </li>
                <li className="p-3 flex items-center justify-between text-sm">
                    <div className="flex-1">
                        <span className="font-mono text-slate-500 line-through">CODE456</span>
                        <p className="text-xs text-slate-500 mt-1">Generated by captain@example.com on 02/01/2023 (Used by user@example.com on 02/02/2023)</p>
                    </div>
...
const UserRoleManagementPreview: React.FC = () => {
    const activeSection = localStorage.getItem('activeSection') as Section | null;
    const isCompany = activeSection === 'company';
    const accentBg = isCompany ? 'bg-company-blue' : 'bg-junior-blue';
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md border border-slate-200">
            <h3 className="text-lg font-semibold text-slate-700 mb-3">User Role Management</h3>
            <ul className="divide-y divide-slate-200 border border-slate-200 rounded-md">
                <li className="p-3 flex items-center justify-between text-sm">
                    <div className="flex-1">
                ...
                <li className="p-3 flex items-center justify-between text-sm">
                    <div className="flex-1">
                        <span className="font-medium text-slate-800">captain@example.com</span>
                        <p className="text-xs text-slate-500 mt-1"><span className="font-semibold">Company Captain</span></p>
                    </div>
                    <button disabled className={`px-3 py-1.5 text-sm font-medium text-white rounded-md shadow-sm ${accentBg} opacity-80 cursor-not-allowed`}>
                        Edit Role
                    </button>
...
const DevelopmentControlsPreview: React.FC = () => (
    <div className="bg-red-50 border-l-4 border-red-400 p-6 rounded-lg shadow-md border border-slate-200">
        <h3 className="text-lg font-semibold text-red-800 mb-3">Development Controls (Admin Only)</h3>
        <div className="space-y-3">
            <button disabled className="w-full px-4 py-2 text-sm font-medium text-white bg-red-600 opacity-80 rounded-md shadow-sm cursor-not-allowed">
